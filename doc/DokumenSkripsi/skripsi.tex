...
\usepackage{multirow} %untuk multirow table
\usepackage{longtable} %untuk tabel melebihi 1 halaman
\usepackage{algorithm} %untuk membuat pseudo code
\usepackage{algorithmic} %untuk membuat pseudo code
...
\newcommand{\prakata}[1]{\vtext{\vprakata}{#1}{\\}}
...
\nottoggle{vsidangakhir}{	
	...
	\begin{flushright} Bandung,\ \vbulan\ \vtahun \\ \vspace{1cm} Anugrah Jaya Sakti \end{flushright}
	\cleardoublepage		
}{}%vsidangakhir
