...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width = 14cm, height = 14cm]{doc/DokumenSkripsi/Gambar/gambar38.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 16cm, height = 14cm ]{doc/DokumenSkripsi/Gambar/gambar37.png}
